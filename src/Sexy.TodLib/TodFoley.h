...
public:
    TodDSoundInstance(class SDLSoundManager* theSoundManager, struct _Mix_Chunk* theSourceSound) : SDLSoundInstance(theSoundManager, theSourceSound) { }

    /*inline*/ int      GetSoundPosition();
    /*inline*/ void     SetSoundPosition(int thePosition);
};
#else
class TodDSoundInstance : public SoundInstance
{
public:
    int  GetSoundPosition() { return 0; }
    void SetSoundPosition(int) { }
    ...
    bool Play(bool, bool) override { return false; }
    void Stop() override { }
