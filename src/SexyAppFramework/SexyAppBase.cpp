...
#include "sound/WebAudioSoundManager.h"
#include "sound/WebSoundInstance.h"
#include "sound/WebMusicInterface.h"
#else
...
#ifdef __EMSCRIPTEN__
		// On web: run loading on main thread to avoid pthreads/SharedArrayBuffer
...
void SexyAppBase::Init()
{
	...
	if (mSoundManager == nullptr)
#ifdef __EMSCRIPTEN__
		mSoundManager = new WebAudioSoundManager();
#else
